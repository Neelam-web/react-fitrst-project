  ...
  return (
    <div className="container cat">
      <div className="text-center my-5 cat">
        ...
        <button className='btn btn-dark' onClick={AddtoCart}><Typed  strings={['Add To Cart']}typeSpeed={100}backSpeed={50}loop={true} /></button>
        ...
        <div className="col-md-6">
          <div className="conatiner">
            ...
            <div>
              ...
              <button className='my-3 mb-2
 btn btn-dark'onClick={SubmitReview}><Typed  strings={['Submit Review']}typeSpeed={100}backSpeed={50}loop={true} /></button>
            </div>
